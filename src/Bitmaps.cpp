...
const XBMBitmap squareIcon = { 24, 8, square_bits };
...
const XBMBitmap sawtoothIcon = { 24, 8, sawtooth_bits };
...
const XBMBitmap triangleIcon = { 24, 8, triangle_bits };
...
const XBMBitmap sineIcon = { 24, 8, sine_bits };
